...
class CreateCuscNhacungcapTTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cusc_nhacungcapT', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            ...
            //$table->foreign('xx_ma')->references('xx_ma')->on('cusc_xuatxu2');
        });
    }
    ...
    {
        Schema::dropIfExists('cusc_nhacungcapT');
    }
}
